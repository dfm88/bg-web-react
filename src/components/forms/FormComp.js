...
import { useFormikContext, Form, Formik, useField } from 'formik';
...
const VALIDATION_SCHEMA = Yup.object(
    {
        ...
        caller: Yup.string("formato non valido").required("Campo obbligatorio").oneOf(['Carabinieri', 'Vigili del Fuoco', 'Prefettura', 'Privato Cittadino',
...
const mainFormErrors = (errors) => {
    console.log('ERRORS in FUNC', Object.keys(errors).length!==0)
